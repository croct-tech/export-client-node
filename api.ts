...
export interface SessionAttributesChanged extends EventPayload {
    'patch': AtomicPatch;
}
export interface SessionClosed extends EventPayload {
    'session': Session;
}
export interface SessionMerged extends EventPayload {
    'session': Session;
    /**
...
export interface SessionStarted extends EventPayload {
    'session': Session;
}
/**
...
export const SetOperationTypeEnum = {
    SET: 'set',
} as const;

export type SetOperationTypeEnum = typeof SetOperationTypeEnum[keyof typeof SetOperationTypeEnum];
...
export const UnsetOperationTypeEnum = {
    UNSET: 'unset',
} as const;

export type UnsetOperationTypeEnum = typeof UnsetOperationTypeEnum[keyof typeof UnsetOperationTypeEnum];
...
export interface UserProfileChanged extends EventPayload {
    'patch': AtomicPatch;
}
...
export const ExportApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        exportEventById: async (eventId: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'eventId' is not null or undefined
            assertParamExists('exportEventById', 'eventId', eventId)
...
export const ExportApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async exportEventById(eventId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<SingleEventResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.exportEventById(eventId, options);
...
export const ExportApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
        ...
        exportEventById(requestParameters: ExportApiExportEventByIdRequest, options?: RawAxiosRequestConfig): AxiosPromise<SingleEventResponse> {
            return localVarFp.exportEventById(requestParameters.eventId, options).then((request) => request(axios, basePath));
        },
        /**
         * 
...
export class ExportApi extends BaseAPI {
    ...
    public exportEventById(requestParameters: ExportApiExportEventByIdRequest, options?: RawAxiosRequestConfig) {
        return ExportApiFp(this.configuration).exportEventById(requestParameters.eventId, options).then((request) => request(this.axios, this.basePath));
    }
