...
------------ | ------------- | ------------- | -------------
**audienceId** | **string** | The ID that uniquely identifies the audience. | [default to undefined]
...
```typescript
import { SlotPersonalizedPersonalization } from '@croct/export';

const instance: SlotPersonalizedPersonalization = {
    audienceId,
    slotId,
    experienceId,
    contentId,
