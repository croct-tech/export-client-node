...
The preferred way to install the export client API is to use the NPM package manager. Simply enter the following command into a terminal window:
...
- Report any bugs or issues on the [issue tracker](https://github.com/croct-tech/exporter-client-node/issues).
- For major changes, please [open an issue](https://github.com/croct-tech/exporter-client-node/issues) first to discuss what you would like to change.
